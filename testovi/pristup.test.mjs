...
const MORA = {
  ...
  direktor: ["/tabla", "/aktivnost", "/zaliha", "/lotovi", "/poruke", "/poruke/primaoci", "/zadaci", "/obavjestenja", "/skladista", "/sledljivost/pretraga?q=MLJ", "/zdravlje"],
  marko: ["/prijem", "/zaliha", "/lotovi", "/zapisi", "/mjerenja", "/isporuke", "/neusaglasenosti", "/zadaci", "/obavjestenja", "/skladista",
    "/kupci", "/dobavljaci", "/artikli", "/vozaci", "/zdravlje"],
  petar: ["/isporuke", "/vozila", "/kontrole-vozila", "/neusaglasenosti", "/zadaci", "/obavjestenja", "/vozaci", "/skladista", "/kupci", "/zaliha", "/zdravlje"],
  konsultant: ["/tabla", "/izvoz/izvori", "/audit", "/pitanja", "/nalozi", "/povlacenja", "/zdravlje"],
};

const NE_SMIJE = {
  direktor: ["/pitanja-firme", "/izvoz/prijemi/pregled", "/izvoz/izvori", "/audit", "/nalozi", "/povlacenja", "/pitanja", "/kontrole-vozila"],
  marko: ["/aktivnost", "/pitanja-firme", "/provjera-znanja/rezultati", "/kontrole-vozila", "/izvoz/izvori", "/nalozi", "/poruke", "/audit", "/povlacenja", "/sledljivost/pretraga?q=MLJ", "/pitanja"],
  petar: ["/izvoz/izvori", "/nalozi", "/poruke", "/audit", "/povlacenja", "/pitanja", "/sledljivost/pretraga?q=MLJ"],
